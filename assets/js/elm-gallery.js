...
var _user$project$Main$ImageList = F2(
	function (a, b) {
		return {result: a, links: b};
	});
var _user$project$Main$imageListDecoder = A3(
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {api_url: a, modal_opened: b, images: c, work_type: d};
	});
var _user$project$Main$Next = {ctor: 'Next'};
var _user$project$Main$Previous = {ctor: 'Previous'};
var _user$project$Main$Paintings = {ctor: 'Paintings'};
var _user$project$Main$Drawings = {ctor: 'Drawings'};
var _user$project$Main$getAllWorkTypes = {
	ctor: '::',
	_0: _user$project$Main$Paintings,
	_1: {
		ctor: '::',
		_0: _user$project$Main$Drawings,
		_1: {ctor: '[]'}
	}
};
var _user$project$Main$ViewWorkType = function (a) {
	return {ctor: 'ViewWorkType', _0: a};
};
var _user$project$Main$viewWorkTypeButton = F2(
	function (model, work_type) {
		var selected_btn = _elm_lang$core$Native_Utils.eq(work_type, model.work_type) ? 'selected' : '';
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'btn btn-primary mb1 work-type ', selected_btn)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$ViewWorkType(work_type)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$NewImageList = function (a) {
	return {ctor: 'NewImageList', _0: a};
};
var _user$project$Main$getImageList = F2(
	function (api_url, work_type) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			api_url,
			A2(
...
var _user$project$Main$init = function (flags) {
	var initial_work_type = _user$project$Main$Paintings;
	return {
		ctor: '_Tuple2',
		_0: {
				...
				if (_p1._0.ctor === 'Next') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								images: _user$project$Helpers_ZipList$forward(model.images)
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								images: _user$project$Helpers_ZipList$back(model.images)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Main$viewModal = function (model) {
	var modal = model.modal_opened ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('gallery-modal'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('modal-close'),
									_1: {
										ctor: '::',
									...
									_elm_lang$html$Html$img,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$src(
												_user$project$Helpers_ZipList$current(model.images)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$CloseModal),
												_1: {ctor: '[]'}
...
var _user$project$Main$MoveTo = function (a) {
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2(_elm_lang$core$Basics_ops['++'], 'gallery-control ', disabled_control))))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$MoveTo(direction)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('sm-col col-12 fit center'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewWorkTypeButton(model),
						_user$project$Main$getAllWorkTypes)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('sm-col col-12 fit gallery'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_user$project$Main$viewControl, model, _user$project$Main$Previous),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('sm-col col-10 flex flex-center gallery-height'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$img,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$OpenModal),
														_1: {ctor: '[]'}
													}
												}
											},
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$viewControl, model, _user$project$Main$Next),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'api_url', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.WorkType":{"args":[],"tags":{"Drawings":[],"Paintings":[]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"ViewWorkType":["Main.WorkType"],"OpenModal":[],"MoveTo":["Main.Direction"],"CloseModal":[],"NewImageList":["Result.Result Http.Error Main.ImageList"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Main.Direction":{"args":[],"tags":{"Next":[],"Previous":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.ImageList":{"args":[],"type":"{ result : String, links : List String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
